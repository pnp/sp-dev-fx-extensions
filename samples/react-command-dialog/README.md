...
-------|----|--------
1.0|June 27, 2017|Update comment
...
```
?loadSpfx=true&debugManifestsFile=https://localhost:4321/temp/manifests.js&customActions={"d94bf442-a979-4c02-8129-c85c64ca2b25":{"location":"ClientSideExtension.ListViewCommandSet.CommandBar"}}
```
Full URL to request would be something like following:

```
contoso.sharepoint.com/Lists/Orders/AllItems.aspx?loadSpfx=true&debugManifestsFile=https://localhost:4321/temp/manifests.js&customActions={"d94bf442-a979-4c02-8129-c85c64ca2b25":{"location":"ClientSideExtension.ListViewCommandSet.CommandBar"}}
```
