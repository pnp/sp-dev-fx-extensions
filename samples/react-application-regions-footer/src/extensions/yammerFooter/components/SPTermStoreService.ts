...
export class SPTermStoreService {
   ...
   * @param guid
   */
  private async projectTermAsync(term: any, parentTerm: any) : Promise<ISPTermObject> {
    ...
    return({ 
      ...
      parentTermName: parentTerm != undefined ? (parentTerm['Name'] !== undefined ? parentTerm['Name'] : "") : "",
      customProperties: term['CustomProperties'] !== undefined ? term['CustomProperties'] : null,
