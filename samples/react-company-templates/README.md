...
| ------- | --------------- | --------------- |---------------  |
| 1.0     | March 29, 2024  | Initial release |Tobias Maestrini| 
| 1.1     | March 13, 2025  | Enhanced with additional features: template preview, advanced filtering, version history, grid view, and bulk operations | Nicolas Kheirallah |
