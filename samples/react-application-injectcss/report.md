# Upgrade project C:\github\react-application-injectcss to v1.6.0
...
```sh
npm i @microsoft/sp-application-base@1.6.0 -SE
```
...
In file [src\extensions\injectCss\InjectCssApplicationCustomizer.manifest.json](src\extensions\injectCss\InjectCssApplicationCustomizer.manifest.json) update the code as follows:
...
File: [src\extensions\injectCss\InjectCssApplicationCustomizer.manifest.json](src\extensions\injectCss\InjectCssApplicationCustomizer.manifest.json)
...
```sh
npm i @microsoft/sp-core-library@1.6.0 @microsoft/sp-dialog@1.6.0 @microsoft/sp-application-base@1.6.0 @microsoft/decorators@1.6.0 @types/webpack-env@1.13.1 @types/es6-promise@0.0.33 -SE
...
#### [src\extensions\injectCss\InjectCssApplicationCustomizer.manifest.json](src\extensions\injectCss\InjectCssApplicationCustomizer.manifest.json)
