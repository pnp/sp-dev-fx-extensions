...
To report a vulnerability, please [create an issue](https://github.com/pnp/sp-dev-fx-extensions/issues/new/choose) and tag the issue as `vulnerability-suspected`.
